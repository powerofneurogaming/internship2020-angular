export const teams = [
    {
        ...
        blurb: "Our game is a more challenging variant of the classic matching card game, in which the player must move cards between two islands to the pattern on each island match.  The difficulty increases with level of play.",
    },
    {
        teamname: "Kelp Forest Team",
        members: [
        ...
        blurb: "Our 2D side-scroller game navigates the main protagonist Plainfin Midshipman across different environments just outside of La Jolla Cove."
    },
    {
        teamname: "Hoyo Negro Team",
        members: [
    ...
    },
    {
        ...
        blurb: "Ours is a 2D click-and-drag game based on projectile motion.  The player assumes the role of a chef attempting to toss food into the mouths of hungry customers, while learning to estimate the force and trajectory of each throw."
    },
    {
        teamname: "Fleischer Task Team",
        members: [
        ...
        blurb: "This game is a based on the classic selective attention and executive control assessment called the Flanker Task.  Our gamified variant has an old-time cartoon theme."
    },
]
